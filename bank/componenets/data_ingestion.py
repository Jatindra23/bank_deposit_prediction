...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe = bank_data.export_collection_as_dataframe(collection_name=self.data_ingestion_config.collection_name)
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        try:
            bank_data = BankData()
            bank_data.save_csv_file(file_path=FILE_NAME,collection_name= COLLECTION_NAME)
