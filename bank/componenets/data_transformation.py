...
from bank.utils.main_utils import save_object, save_numpy_array_data, read_yaml_file
    ...
    def initiate_data_transformation(
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                preprocessors = self.get_data_transformer_object()
                ...
                input_feature_train_df = preprocessors.fit_transform(
                ...
                input_feature_test_df = preprocessors.transform(input_feature_test_df)
