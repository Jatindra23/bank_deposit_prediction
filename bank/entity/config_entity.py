# In this file we will create all the files and folder paths which are required for data_ingestio pipeline.

from datetime import datetime
import os
import sys
from bank.exception import BankException
from bank.constant import training_pipeline
...
class DataValidationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.data_drift_report_page_file_path: str = os.path.join(
            self.data_validation_dir,
            training_pipeline.DATA_VALIDATION_DRIFT_REPORT_DIR,
            training_pipeline.DATA_VALIDATION_DRIFT_REPORT_PAGE_FILE_NAME,
        )
